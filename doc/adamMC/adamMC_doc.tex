...
\lstinputlisting[mathescape]{dialogs/ui.tex}\todo{adapt the module list}
...
with the resulting output:\todo{todo}
\begin{lstlisting}[language=bash]
  $ ./adam_mc
\end{lstlisting}
...
For example for a transition \todo{add example}
...
%i s a comma s e p a r a t e d l i s t o f a p r e s e t p l a c e −> s e t o f p o s t s e t p l a c e s
